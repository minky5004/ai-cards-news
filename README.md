...
<sub>같은 카드를 싣는 정적 사이트 · 캐러셀·확대·전환 전부 라이브러리 없이 CSS 와 스크립트로</sub>
...
- 예약 지연 발화 방치(31일 관측 · 40분~9시간 57분 · 중앙값 1시간 10분) — 예약 시각 앵커 · 24시간까지 같은 날짜
...
| 무인 종단 완주 | 4일 연속 관측 — run `30459911527` · `30550181481` · `30637611313` · `30701713207` |
| 테스트 133개 | 코드를 일부러 깨뜨려 **실패하는지** 확인 |
