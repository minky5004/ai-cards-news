...
<sub>2026-08-28 발행분 · 07-26 이후 34일 전량 → <b><a href="https://minky5004.github.io/ai-cards-news/">사이트</a></b></sub>
...
| 무인 종단 완주 | 07-28~08-28 스케줄 32회 중 30회 — 끊긴 둘은 Pages 배포 타임아웃(`31110053608`) · 기사 본문의 키 형태로 막힌 푸시(`31600410158`) |
| 테스트 156개 | 코드를 일부러 깨뜨려 **실패하는지** 확인 |
...
- 카드 생김새의 단일 출처 `templates/card.html` · 한글 폰트는 러너에 없어 `assets/fonts/` 동봉
